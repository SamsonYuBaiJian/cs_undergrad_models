...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = np.random.normal(loc=0.0, scale=weight_scale, size=(num_filters * (input_dim[1] // 2) * (input_dim[1] // 2), hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        h1, c1 = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        ...
        dh2, grads['W3'], grads['b3'] = affine_backward(dout, c3)
        dh1, grads['W2'], grads['b2'] = affine_relu_backward(dh2, c2)
        _, grads['W1'], grads['b1'] = conv_relu_pool_backward(dh1, c1)
